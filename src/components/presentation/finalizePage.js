  ...
  function Finalize(props) {
    ...
    const saveToDatabase= async()=>{
      ...
      if(user.resumeIds!=undefined){
        obj = {...user.resumeIds, [document.id]:{document: document,contactSection: contactSection,educationSection: educationSection}}
      }else{
        obj={[document.id]:{document: document,contactSection: contactSection,educationSection: educationSection}};
      }
